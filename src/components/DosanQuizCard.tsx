...
export default function DosanQuizCard() {
  ...
  return (
    <>
      ...
      {/* pt-[11.5px] — 카드 위 흰 여백 (2026-09-25 사용자 "0.5px 줄여줘" → "좀 줄여줘" → "2px 더", 17 → 16.5 → 13.5 → 11.5px). 캘린더 박스와 함께. */}
      <section className="rounded-3xl bg-surface px-5 pt-[11.5px] pb-5 shadow-[var(--shadow-card-flat)]">

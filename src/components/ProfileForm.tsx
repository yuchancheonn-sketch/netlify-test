...
function flatBox(className: string): string {
  ...
  return className
    ...
    // 둘레 색을 조금 진하게 — brand-200을 60%로 했다가(2026-09-27 사용자 요청), 같은 날 "더 진하게"로 brand-200 그대로.
    .replace("focus:ring-brand-100", "focus:ring-brand-200")
...
export default function ProfileForm({
  ...
  function handlePickPhoto(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    // 여러 장 고르기·고른 사진 격자는 같은 날 사용자 요청으로 뺐습니다 — 한 장만 골라 편집합니다.
    setSaveError(null);
  ...
  return (
    <form onSubmit={handleSubmit} className="px-5 pb-10">
      ...
      */}
      ...
      {/* 생일 */}
      <div className="mb-6">
        <FieldLabel labelClassName={LABEL_SIZE} hintClassName={HINT_TONE} hint="선택">생일</FieldLabel>
        {/*
      ...
      <div className="mb-6">
        <FieldLabel labelClassName={LABEL_SIZE} hintClassName={HINT_TONE} hint="선택">구분</FieldLabel>
            ...
            return (
              ...
              >
                {/*
                  ...
                  굵기 bold(700) → semibold(600) — "조금만 더 얇게"(2026-09-27 사용자 요청).
                */}
                <span
                  className={`-translate-y-[1.5px] text-[15px] font-semibold ${
      ...
      <div className="mb-6">
        <FieldLabel labelClassName={LABEL_SIZE} htmlFor="company" hintClassName={HINT_TONE} hint="선택">
          회사·소속
        </FieldLabel>
        <input
          id="company"
      ...
      <div className="mb-6">
        <FieldLabel labelClassName={LABEL_SIZE} htmlFor="position" hintClassName={HINT_TONE} hint="선택">
          직책
        </FieldLabel>
        <input
          id="position"
      ...
      */}
      <div className="mb-6">
        <FieldLabel labelClassName={LABEL_SIZE} htmlFor="councilRole" hintClassName={HINT_TONE} hint="선택">
          원우회 직위
        </FieldLabel>
        <input
          id="councilRole"
      ...
      {/* 소개 영상 */}
      <div className="mb-8">
        <FieldLabel labelClassName={LABEL_SIZE} htmlFor="introVideoUrl" hintClassName={HINT_TONE} hint="선택">
          소개 영상 링크
        </FieldLabel>
        <input
          id="introVideoUrl"

    ...
    <>
      <div className="mx-auto flex min-h-dvh w-full max-w-[560px] flex-col">
        {/*
          ...
          알약 윗변이 바닥에서 63px이라(띄운 -1px + 높이 64px) 그보다 넉넉히
        ...
        <main
          className={
            fullScreen
              ...
              : "flex-1 pb-[calc(81px+env(safe-area-inset-bottom))]"
          }
        >
          {children}
        </main>
 ...
 *
 * 기준이 되는 31px = 알약을 바닥에서 띄운 -1px + 알약 높이 64px의 절반.
...
function BottomTabBarScrim() {
  ...
  const height = "calc(31px + env(safe-area-inset-bottom))";

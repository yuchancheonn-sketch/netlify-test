    ...
    <>
      <div className="mx-auto flex min-h-dvh w-full max-w-[560px] flex-col">
        {/*
          ...
          알약 윗변이 바닥에서 64px이라(띄운 0px + 높이 64px) 그보다 넉넉히
        ...
        <main
          className={
            fullScreen
              ...
              : "flex-1 pb-[calc(82px+env(safe-area-inset-bottom))]"
          }
        >
          {children}
        </main>
 ...
 *
 * 기준이 되는 32px = 알약을 바닥에서 띄운 0px + 알약 높이 64px의 절반.
...
function BottomTabBarScrim() {
  ...
  const height = "calc(32px + env(safe-area-inset-bottom))";

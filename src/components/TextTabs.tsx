...
export default function TextTabs<T extends string>({
  ...
  /**
   * "body"   본문 맨 위에 놓이는 보통 고르개. 17px, 왼쪽 7px 들여씀, 화면 끝까지 회색 헤어라인.
  ...
  return (
     ...
     *
     * pl-[7px] — 왼쪽으로 7px 들여 씁니다(2026-09-14 사용자 요청으로 12px → 10px → 8px → 7px).
     * 쓰는 쪽이 px-4(16px) 안에 두므로 화면 끝에서 23px입니다. 끝에 바짝 붙이면 글자만 있는 줄이라 허전합니다.

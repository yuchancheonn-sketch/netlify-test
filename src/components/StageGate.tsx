 ...
 *
 * ★ 바탕은 bg-canvas입니다. 지금 canvas는 흰색이고(홈 탭만 연한 회색, globals.css "홈 탭 바탕"),
 *   홈 화면에 추가한 앱의 스플래시(manifest의 BRAND_BACKGROUND)도 흰색입니다.
 *   이 화면은 홈 표시(data-home-canvas)를 품지 않으므로 홈으로 열리는 앱에서도 흰색이고,
 *   로딩이 끝나 홈이 나타날 때 흰색 → 연한 회색으로 바뀝니다(두 색이 거의 같아 눈에 띄지 않습니다).
 *

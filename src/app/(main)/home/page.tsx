    ...
    <>
      ...
      */}
      ...
      {/*
        ...
        pt-2.5 — 맨 위 OX 퀴즈 카드와 제목 줄 사이 10px
        (16px(2026-09-14) → 12px(2026-09-22 사용자 "박스 위 간격 좀 줄여줘") → 10px(2026-09-25 사용자 "조금만 더 줄여줘")).
        제목 줄의 pb(6px)에 더해 16px이 됩니다 (예전 22px → 18px).

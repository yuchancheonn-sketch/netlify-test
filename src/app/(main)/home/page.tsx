    ...
    <>
      ...
      */}
      ...
      {/*
        ...
        pt-4 — 맨 위 카드와 제목 줄 사이 16px (2026-09-14).
      ...
      */}
      <div className="flex flex-col gap-4 px-4 pt-4">
        {/*
          ...
          맨 위에 둡니다 — 2026-09-14 사용자 요청으로 OX 퀴즈 위로 올렸습니다.
        */}
        <section>
          {upcoming.loading ? (
        ...
        {/* 오늘의 OX 퀴즈 — 도산 안창호 선생에 관한 문제가 하루 하나씩. D-day 카드 바로 아래. */}
        <DosanQuizCard />

        {/*
          투표·의견 모으기 — 원우 누구나 열 수 있고, 열려 있는 것만 여기 올라옵니다.
          OX 퀴즈 아래에 둡니다(2026-09-11 — 예전엔 이후 일정 아래).

    ...
    <>
      ...
      */}
      {/*
        ...
        ★ 글꼴은 바탕체(명조, font-serif = Noto Serif KR) — 같은 날 사용자 "한글로 되돌리고 바탕체로"
          (그 사이 한자 "愛己愛他"로 잠깐 바꿨다가 되돌림). 명조는 400·600 두 굵기만 받아 두어, 제목의 굵게(700)는 600으로 그려집니다.
      */}
      <PageHeader
        title={
          canSwitch ? (
            <span className="flex items-center gap-2">
              <span className="font-serif text-[24.5px] text-brand-500">{APP_DEFINITION_TITLE}</span>
      ...
      <div className="flex flex-col gap-[14px] px-4 pt-2">
        ...
        */}
        <section>
          {upcoming.loading || academy.loading ? (
            /* 큰 D-day 카드(2026-09-25 C안)와 같은 높이 — 위아래 16px + 왼쪽 칸(D-day 28 · 6 · 날짜 12) 약 50px ≈ 82px.
               (같은 날 잠깐 쓴 머리띠 카드는 109px, 2026-09-23~25의 두 줄 카드는 81px이었습니다.) */
            ...
            */
            <div className="flex items-center gap-3 rounded-card bg-surface py-3 pr-[11px] pl-5 shadow-[var(--shadow-card-flat)]">
        ...
        */}
        ...
        <section>
          ...
          */}
          <div className="rounded-card bg-surface px-6 pt-5 pb-6 shadow-[var(--shadow-card-flat)]">

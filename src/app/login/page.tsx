    ...
    <div className="relative mx-auto min-h-dvh w-full max-w-[480px] overflow-hidden bg-canvas">
      ...
      */}
      <div
        ...
        // → 168px → 158px → 148px — 사진 5px, 10px, 10px 더 위로 (2026-09-27 사용자 요청).
        className="pointer-events-none absolute inset-x-0 top-[148px] h-[72%] bg-cover bg-no-repeat"
        style={{
          ...
          */}
          ...
          <div className="flex flex-col gap-[11px]">
              ...
              >
                ...
                <span className="-translate-y-[1.25px]">구글 계정으로 로그인</span>
              </button>
              ...
              */}
              ...
              >
                ...
                <span className="-translate-y-[1.25px]">휴대폰 번호로 로그인</span>
              </button>
